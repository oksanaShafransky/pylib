...
class AppsPathResolver(object):
    ...
    def __init__(self, ti):
        ...
        self.apps_paths = {
            ...
            'monitoring-usagetime-window': {'main_path': "apps-monitoring/usagetime/window",
                                        'size': 4.5 * MB,
                                        'marker': True, 'path_type': "daily"},
            'monitoring-retention-window1': {'main_path': "apps-monitoring/retention/window1",
                                            'size': 900 * KB,
                                            'marker': True, 'path_type': "daily"},
            'monitoring-retention-window7': {'main_path': "apps-monitoring/retention/window7",
                                             'size': 900 * KB,
                                             'marker': True, 'path_type': "daily"},
            'monitoring-retention-window30': {'main_path': "apps-monitoring/retention/window30",
                                             'size': 900 * KB,
                                             'marker': True, 'path_type': "daily"},
    ...
    def get_monitoring_retention_window1(self, in_or_out, path_prefix=None, path_suffix=None, td = 0):
        return self.__create_app_path_object(self.__get_android_apps_analytics_base(in_or_out, path_prefix),
                                             self.apps_paths['monitoring-retention-window1'], path_suffix, in_or_out)
    def get_monitoring_retention_window7(self, in_or_out, path_prefix=None, path_suffix=None, td = 0):
        return self.__create_app_path_object(self.__get_android_apps_analytics_base(in_or_out, path_prefix),
                                             self.apps_paths['monitoring-retention-window7'], path_suffix, in_or_out)
    def get_monitoring_retention_window30(self, in_or_out, path_prefix=None, path_suffix=None, td = 0):
        return self.__create_app_path_object(self.__get_android_apps_analytics_base(in_or_out, path_prefix),
                                             self.apps_paths['monitoring-retention-window30'], path_suffix, in_or_out)
