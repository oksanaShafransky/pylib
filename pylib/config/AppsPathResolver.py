...
class AppsPathResolver(object):
    ...
    def __init__(self, ti):
        ...
        self.apps_paths = {
            ...
            'extractor_1005': {'main_path': "daily/extractors/extracted-metric-data/rtype=R1005", 'size': 88 * MB,
                               'marker': True, 'path_type': "daily"},
            ...
            'grouping_1005_report_parquet_upsolver': {'main_path': "stats-mobile/parquet_adjusted/rtype=R1005", 'size': 170 * MB,
                                             'marker': False,
                                             'path_type': "daily"},
