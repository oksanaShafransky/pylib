...
class PtaskInvoker(Program):
    def core_args(self):
        ...
        extra_args = [
            ...
            Argument(names=('buffer_size', 'bs'), help="DataArtifact buffer size", optional=True),
    ...
    def config(self):
        ...
        if self.args.buffer_size.value:
            sw_tasks['buffer_size'] = self.args.buffer_size.value
